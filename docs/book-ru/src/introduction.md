...
- [examples/](https://github.com/aura-config/aura-lang/tree/main/examples) —
  работающие примеры с ожидаемыми выводами.

> Основная версия книги — [английская](../). Русская публикуется под `/book/ru/`
> и является полным переводом; при расхождении верна английская.
