...
| [ci_matrix/](ci_matrix/) | Генерация CI-матрицы через `map` вместо ручного перечисления комбинаций | `aura eval ci_matrix.aura` |
