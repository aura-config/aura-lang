...
- Идентификатор: `[a-zA-Z_][a-zA-Z0-9_]*`, затем сверка с таблицей ключевых слов (`import as type def end domain new assert shadow true false null`).
